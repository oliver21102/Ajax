		...
		switch ($_POST['accion']) {
			case 'addUser':
				...
				$query = sprintf("INSERT INTO tbl_usuarios
								 SET usr_nombre='%s', usr_madre='%s', usr_padre='%s',usr_talento='%s',edad='%s',aula='%s', usr_status='%s'",
								 $_POST['usr_nombre'],$_POST['usr_madre'],$_POST['usr_padre'],$_POST['usr_talento'],$_POST['edad'],$_POST['aula'],$_POST['usr_status']);
				...
				if($resultadoQuery == true){
					...
					$contenidoOK = '
						<tr>
							...
							<td>'.$_POST['usr_madre'].'</td>
							<td>'.$_POST['usr_padre'].'</td>
							<td>'.$_POST['usr_talento'].'</td>
							<td>'.$_POST['edad'].'</td>
							<td>'.$_POST['aula'].'</td>
			...
			case 'editUser':
				// Armamos el query
		if(!empty($_POST['talentoIncremento'])){

		$valor=$_POST['usr_talento']+ $_POST['talentoIncremento'];	
		}
		if(!empty($_POST['talentoDisminuye'])){
    $valor=$_POST['usr_talento'] - $_POST['talentoDisminuye'];
				...
				$query = sprintf("UPDATE tbl_usuarios
								 ...
								 $_POST['usr_nombre'],$_POST['usr_madre'],$_POST['usr_padre'],$valor,$_POST['edad'],$_POST['aula'],$_POST['usr_status'],$_POST['id_user']);
