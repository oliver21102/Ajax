...
$(function(){
		...
		$('body').on('click','#listaUsuariosOK a',function (e){
			...
			if( accion_ok == 'editar'){
				...
				$('#usr_madre').val($(this).parent().parent().children('td:eq(1)').text());
				$('#usr_padre').val($(this).parent().parent().children('td:eq(2)').text());
				$('#usr_talento').val($(this).parent().parent().children('td:eq(3)').text());
				$('#edad').val($(this).parent().parent().children('td:eq(4)').text());
				$('#aula').val($(this).parent().parent().children('td:eq(5)').text());

				// Seleccionar status
				$('#usr_status option[value='+ $(this).parent().parent().children('td:eq(6)').text() +']').attr('selected',true);
